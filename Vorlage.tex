%Dateiname der PDF definieren
% !TEX jobname = Mein_PDF_Dateiname
...
%Titelblatt
\pagestyle{empty}
\include{Sections-Default/Title-Informationstechnik}
%\include{Sections-Default/Title-Elektrotechnik}

%Sperrvermerk
\pagestyle{empty}
\include{Sections-Default/Sperrvermerk-Informationstechnik}
%\include{Sections-Default/Sperrvermerk-Elektrotechnik}

\pagenumbering{Roman}

%Eigenleistung
\include{Sections-Default/Eigenleistung}

%Abstract
%\include{Sections-Default/Abstract-Englisch}
\include{Sections-Default/Abstract-Deutsch}
...
%\include{Sections-Default/Vorwort}
